...
<div class="container center w-800">
   ...
   <a href="store/categoryList?storeCategory=치킨" class="storeCategory" >
    치킨 <img src="https://media.discordapp.net/attachments/1187318496942628876/1218122788485992449/image0.jpg?ex=66068440&is=65f40f40&hm=ec7ef7954591f58f89ca309828ab4161c6f33b923b02051b2916dcf5b2041294&=&format=webp">
        ...
        <a href="/categoryList?storeCategory=치킨" class="storeCategory" onclick="filterByCategory('피자');">
        ...
        <a href="#" class="storeCategory" onclick="filterByCategory('중식');">
        ...
        <a href="#" class="storeCategory" onclick="filterByCategory('한식');">
    ...
    <div class="cell center">
        <a href="#" class="storeCategory" onclick="filterByCategory('일식');">
        ...
        <a href="#" class="storeCategory" onclick="filterByCategory('야식');">
        ...
        <a href="#" class="storeCategory" onclick="filterByCategory('분식');">
        ...
        <a href="#" class="storeCategory" onclick="filterByCategory('카페');">
