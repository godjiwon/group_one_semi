...
<body>
    ...
    <div class="cell center my-50" style="position: relative; display: inline-block;">
		...
		<br> <br> <a href="store/categoryList?storeCategory=치킨"
			class="storeCategory"> 치킨 <img class="pb-40"
			...
			class="storeCategory"> 피자/양식 <img class="pb-50"
	...
	<div class="cell center food-category">
		<a href="store/categoryList?storeCategory=일식/돈까스"
			class="storeCategory"> 일식/돈까스 <img class="pb-50"
			...
			class="storeCategory"> 카페/디저트 <img class="pb-50"
